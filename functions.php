...
function admin_styles() {
    ...
    wp_enqueue_script( 'vegasjs', get_template_directory_uri() . '/login/js/vegas.min.js', array('jquery'), '2.5.1', true);
...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('toursDestacado', 705, 391, true); // Tours
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('lightboxJS', get_template_directory_uri().'/js/lightbox.min.js', array('jquery'), '2.11.1', true);
        wp_enqueue_script('lightboxJS'); // Enqueue it!
        wp_register_script('bxsliderJS', get_template_directory_uri().'/js/jquery.bxslider.js', array('jquery'), '4.2.14', true);
        wp_enqueue_script('bxsliderJS'); // Enqueue it!
        wp_register_script('slicknav', get_template_directory_uri().'/js/jquery.slicknav.min.js', array('jquery'), '1.0.10', true);
...
function html5blank_styles()
{
    ...
    wp_register_style('lightboxCSS', get_template_directory_uri() . '/css/lightbox.min.css', array(), '2.11.1');
    wp_enqueue_style('lightboxCSS'); // Enqueue it!
    wp_register_style('bxsliderCSS', get_template_directory_uri() . '/css/jquery.bxslider.css', array(), '4.2.14');
    wp_enqueue_style('bxsliderCSS'); // Enqueue it!
    wp_register_style('slicknavCSS', get_template_directory_uri() . '/css/slicknav.min.css', array(), '4.2.14');
    wp_enqueue_style('slicknavCSS'); // Enqueue it!
    wp_register_style( 'oxigen', 'https://fonts.googleapis.com/css2?family=Oxygen', array(), '1.0', 'all' );
    wp_enqueue_style('oxigen'); // Enqueue it!
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        ...
        'description' => __('Agregue aqui sus cupones (Maximo 2)', 'html5blank'),
        'id' => 'widget-area-1',
...
{
    global $post;
    return '... <a class="view-article" href="' . get_permalink($post->ID) . '">' . __('Ver Articulo', 'html5blank') . '</a>';
}
...
//add_action('init', 'testimoniales_posttype'); // Agregar Testimoniales
add_action('init', 'slider_posttype' ); // Slider para Pantalla de Inicio
