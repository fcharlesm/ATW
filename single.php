	...
	<?php if (have_posts()): while (have_posts()) : the_post(); ?>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="grid1-3">
				...
				<span class="comments"><?php if (comments_open( get_the_ID() ) ) comments_popup_link( __( 'Deja tus comentarios', 'html5blank' ), __( '1 Comment', 'html5blank' ), __( '% Comments', 'html5blank' )); ?></span>
				<!-- /post details -->
